...
<main class="flex-grow p-margin-mobile flex flex-col gap-gutter pb-24 md:pb-8 max-w-container-max mx-auto w-full">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-outline-variant pb-4">
        <div>
            <h2 class="font-headline-lg text-headline-lg text-on-background uppercase tracking-tight">📝 Nueva Salida</h2>
            <p class="text-on-surface-variant max-w-xl font-label-md text-label-md uppercase">Crea una nueva ruta para los socios.</p>
        </div>
    ...
    <div class="bg-surface-container rounded-xl chrome-border p-6 md:p-8">
        <form action="guardar_salida.php" method="POST" enctype="multipart/form-data" class="space-y-5">
            <div>
            ...
            <div>
                ...
                <textarea name="descripcion" id="descripcion" rows="5" class="input-dark" placeholder="Detalles de la ruta, paradas..."></textarea>
            </div>
            <div>
